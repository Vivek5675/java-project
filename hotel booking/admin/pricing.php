...
<a href="add-pricing.php" class="btn btn-primary float-right veiwbutton">Add
Pricing</a>
</div>
</div>
</div>
...
<h6 class="card-price text-center mt-3">1000 RS<span class="period"></span>
</h6>
<hr>
<ul class="fa-ul">
...
<a href="edit-pricing.php" class="btn btn-block btn-primary text-uppercase">Edit</a>
</div>
</div>
</div>
...
<h6 class="card-price text-center mt-3">2000 RS<span class="period"></span>
</h6>
<hr>
<ul class="fa-ul">
<li><span class="fa-li"><i class="fas fa-check"></i></span>Free
...
<h6 class="card-price text-center mt-3">3500 RS<span class="period"></span>
</h6>
<hr>
<ul class="fa-ul">
<li><span class="fa-li"><i class="fas fa-check"></i></span>Free
